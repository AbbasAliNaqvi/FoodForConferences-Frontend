...
const ProfileScreen = () => {
  ...
  const fallbackAvatarUrl = 'https://avatar.iran.liara.run/public';
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.avatarContainer}>
          <Image 
            source={{ uri: user?.logoUrl || fallbackAvatarUrl }} 
            style={styles.avatar} 
          />
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoBlock}>
            ...
            <Text style={styles.infoText}>+91 {user?.phone || randomMobile}</Text>
          </View>
        </View>
